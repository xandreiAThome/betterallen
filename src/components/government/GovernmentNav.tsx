...
const GovernmentNav: React.FC<GovernmentNavProps> = ({
  variant = 'internal',
}) => {
          ...
          <div className="flex flex-col gap-3">
            {branches.map(branch => (
              <Link
                ...
                rounded-2xl hover:border-primary-200 border-gray-200 
                text-gray-900 shadow-sm hover:shadow-sm"
              >
