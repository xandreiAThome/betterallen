      ...
      <div className="max-w-352 mx-auto">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="h-full">
            <div className="flex flex-col justify-between h-full p-8 transition-all duration-200 bg-white border border-gray-200 shadow-sm rounded-2xl hover:border-primary-300 hover:shadow-md">
              <div>
          ...
          {/* BetterGov Card */}
          <motion.div variants={itemVariants} className="h-full">
            <div className="flex flex-col justify-between h-full p-8 transition-all duration-200 border shadow-sm bg-primary-600 border-primary-700 rounded-2xl hover:bg-primary-500">
              <div>
